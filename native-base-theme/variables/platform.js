...
export default {
  ...
  // Color
  brandPrimary: platform === PLATFORM.IOS ? '#4487F7' : '#4487F7',
  brandInfo: '#62B1F6',
  brandSuccess: '#5cb85c',
  brandDanger: '#d9534f',
  brandWarning: '#f0ad4e',
  ...
  // Footer
  footerHeight: 55,
  footerDefaultBg: platform === PLATFORM.IOS ? '#705c82' : '#705c82',
  ...
  tabActiveBgColor: platform === PLATFORM.IOS ? '#cde1f9' : '#2F2D55',
